...
func main() {
	...
	services := chat.NewServices(repository.New(gormDB), nil, search.New(cfg.ElasticsearchURL), cfg.ElasticsearchMessagesIndex, cfg.ElasticsearchConversationsIndex)
